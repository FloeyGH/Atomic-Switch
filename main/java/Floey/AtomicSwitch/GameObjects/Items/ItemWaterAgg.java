...
public class ItemWaterAgg extends ItemAS {
    public ItemWaterAgg() {
        this.setMaxDamage(-1);
        this.setUnlocalizedName("ItemWaterAgg");
        this.setMaxStackSize(1);
        this.setNoRepair();
        this.setTextureName("atomicswitch:ItemWaterAgg");
    }
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer entity) {
        ...
        if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            world.playSoundAtEntity(entity, "liquid.water", 1.0F, 1.0F);
    ...
    {
        list.add("\u00A73Right-click to set Water");
